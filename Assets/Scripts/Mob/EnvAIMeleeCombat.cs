...
[RequireComponent(typeof(EnvMeleeMobAI)), RequireComponent(typeof(MobPrefab))]
public class EnvAIMeleeCombat : NetworkBehaviour
{
    private EnvMeleeMobAI moveScript;
    ...
    void Start()
    {
        moveScript = GetComponent<EnvMeleeMobAI>();
